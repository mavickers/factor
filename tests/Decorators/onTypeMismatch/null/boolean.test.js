...
describe("@onTypeMismatch decorator tests null option for boolean type", () => {
    beforeEach(() => {
    ...
    describe("when set on classes", () => {
        ...
        it.skip("should set values to null when class is defined with type mismatches", () => {
            expect(() => @onTypeMismatch("Null") class { @is(Boolean) field1 = "true" }).not.toThrow();
            expect(() => @onTypeMismatch(TypeMismatchSetOptions.Null) class { @is(Boolean) field1 = "false" }).not.toThrow();
        });
    ...
    describe("when set on fields", () => {
        beforeEach(() => {
            Class1 = class {
                @is(Boolean) @onTypeMismatch("Null") field1;
                @is("boolean") @onTypeMismatch("Null") field2;
                @is(Boolean) field3;
                @is("boolean") field4;
                @is(Boolean) @onTypeMismatch(TypeMismatchSetOptions.Null) field5;
                @is("boolean") @onTypeMismatch(TypeMismatchSetOptions.Null) field6;
                @is(Boolean) @onTypeMismatch("Null") field7 = true;
                @is("boolean") @onTypeMismatch("Null") field8 = false;
                @is(Boolean) @onTypeMismatch(TypeMismatchSetOptions.Null) field9 = true;
                @is("boolean") @onTypeMismatch(TypeMismatchSetOptions.Null) field10 = false;
            }
        ...
        it("should override class option when set on field", () => {
            expect(() => {
                Class3 =  @onTypeMismatch("Ignore") class {
                    ...
                    @is(Boolean) @onTypeMismatch("Null") field1;
                    @is("boolean") @onTypeMismatch("Null") field2;
                    @is(Boolean) @onTypeMismatch(TypeMismatchSetOptions.Null) field3;
                    @is("boolean") @onTypeMismatch(TypeMismatchSetOptions.Null) field4;
                    @is(Boolean) @onTypeMismatch("Null") field5 = true;
                    @is(Boolean) @onTypeMismatch("Null") field6 = "true";
                };
