...
describe("@onTypeMismatch decorator null option for string type tests", () => {
    beforeEach(() => {
    ...
    describe("when set on classes", () => {
        ...
        it.skip("should set values to null when class is defined with type mismatches", () => {
            expect(() => @onTypeMismatch("Null") class { @is(String) field1 = "true" }).not.toThrow();
            expect(() => @onTypeMismatch(TypeMismatchSetOptions.Null) class { @is(String) field1 = "false" }).not.toThrow();
        });
    ...
    describe("when set on fields", () => {
        beforeEach(() => {
            Class1 = class {
                @is(String) @onTypeMismatch("Null") field1;
                @is("string") @onTypeMismatch("Null") field2;
                @is(String) field3;
                @is("string") field4;
                @is(String) @onTypeMismatch(TypeMismatchSetOptions.Null) field5;
                @is("string") @onTypeMismatch(TypeMismatchSetOptions.Null) field6;
                @is(String) @onTypeMismatch("Null") field7 = "1";
                @is("string") @onTypeMismatch("Null") field8 = "100.1";
                @is(String) @onTypeMismatch(TypeMismatchSetOptions.Null) field9 = "1";
                @is("string") @onTypeMismatch(TypeMismatchSetOptions.Null) field10 = "100.1";
            }
        ...
        it("should not throw when fields are not set at instantiation according to type", () => {
            let Class4, model4;
            expect(() => Class4 = class { @is(String) @onTypeMismatch("Null") field1 = true }).not.toThrow();
            ...
            expect(() => model4 = new Class4()).not.toThrow();
            expect(model4.field1).toBeNull();
            expect(() => Class4 = class { @is(String) @onTypeMismatch(TypeMismatchSetOptions.Null) field1 = true }).not.toThrow();
            expect(Class4).not.toBeUndefined();
            expect(() => model4 = new Class4()).not.toThrow();
            expect(model4.field1).toBeNull();
            expect(() => Class4 = class { @is("string") @onTypeMismatch(TypeMismatchSetOptions.Null) field1 = true }).not.toThrow();
        ...
        it("should override class option when set on field", () => {
            expect(() => {
                Class3 =  @onTypeMismatch("Ignore") class {
                    ...
                    @is(String) @onTypeMismatch("Null") field1;
                    @is("string") @onTypeMismatch("Null") field2;
                    @is(String) @onTypeMismatch(TypeMismatchSetOptions.Null) field3;
                    @is("string") @onTypeMismatch(TypeMismatchSetOptions.Null) field4;
                    @is(String) @onTypeMismatch("Null") field5 = "1";
                    @is(String) @onTypeMismatch("Null") field6 = 1;
                };
