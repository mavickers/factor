...
describe("@onTypeMismatch decorator noop option for string type tests", () => {
    beforeEach(() => {
    ...
    describe("when set on classes", () => {
        ...
        it.skip("should set values to null when class is defined with type mismatches", () => {
            expect(() => @onTypeMismatch("Noop") class { @is(String) field1 = "true" }).not.toThrow();
            expect(() => @onTypeMismatch(TypeMismatchSetOptions.Noop) class { @is(String) field1 = "false" }).not.toThrow();
        });
    ...
    describe("when set on fields", () => {
        beforeEach(() => {
            Class1 = class {
                @is(String) @onTypeMismatch("Noop") field1;
                @is("string") @onTypeMismatch("Noop") field2;
                @is(String) field3;
                @is("string") field4;
                @is(String) @onTypeMismatch(TypeMismatchSetOptions.Noop) field5;
                @is("string") @onTypeMismatch(TypeMismatchSetOptions.Noop) field6;
                @is(String) @onTypeMismatch("Noop") field7 = "true";
                @is("string") @onTypeMismatch("Noop") field8 = "false";
                @is(String) @onTypeMismatch(TypeMismatchSetOptions.Noop) field9 = "true";
                @is("string") @onTypeMismatch(TypeMismatchSetOptions.Noop) field10 = "false";
            }
        ...
        it("should not throw when fields are not set at instantiation according to type", () => {
            let Class4, model4;
            expect(() => Class4 = class { @is(String) @onTypeMismatch("Noop") field1 = true }).not.toThrow();
            ...
            expect(() => model4 = new Class4()).not.toThrow();
            expect(model4.field1).toBeUndefined();
            expect(() => Class4 = class { @is(String) @onTypeMismatch(TypeMismatchSetOptions.Noop) field1 = true }).not.toThrow();
            expect(Class4).not.toBeUndefined();
            expect(() => model4 = new Class4()).not.toThrow();
            expect(model4.field1).toBeUndefined();
            expect(() => Class4 = class { @is("string") @onTypeMismatch(TypeMismatchSetOptions.Noop) field1 = true }).not.toThrow();
        ...
        it("should override class option when set on field", () => {
            expect(() => {
                Class3 =  @onTypeMismatch("Ignore") class {
                    ...
                    @is(String) @onTypeMismatch("Noop") field1;
                    @is("string") @onTypeMismatch("Noop") field2;
                    @is(String) @onTypeMismatch(TypeMismatchSetOptions.Noop) field3;
                    @is("string") @onTypeMismatch(TypeMismatchSetOptions.Noop) field4;
                    @is(String) @onTypeMismatch("Noop") field5 = "true";
                    @is(String) @onTypeMismatch("Noop") field6 = true;
                };
            ...
            expect(() => model3.fieldA = true).not.toThrow();
            expect(() => model3.fieldB = false).not.toThrow();
            expect(model3.fieldA).toEqual(true);
            expect(model3.fieldB).toEqual(false);
            // expect(model3.fieldC).toEqual("testC");
            // expect(model3.fieldD).toEqual("testD");
            expect(() => model3.field1 = true).not.toThrow();
            expect(() => model3.field2 = false).not.toThrow();
            expect(() => model3.field3 = true).not.toThrow();
            expect(() => model3.field4 = false).not.toThrow();
